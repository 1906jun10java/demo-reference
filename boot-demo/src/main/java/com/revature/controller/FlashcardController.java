...
public class FlashcardController {
	...
	public ResponseEntity<List<Flashcard>> getFlashcardsByTopic(@PathVariable FlashcardTopic topic) {
		List<Flashcard> cardList = flashcardService.getFlashcardsByTopics(topic);
		if (cardList == null) {
